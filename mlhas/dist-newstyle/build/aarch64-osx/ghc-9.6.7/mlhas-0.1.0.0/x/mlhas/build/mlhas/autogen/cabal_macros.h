...
/* package mlhas-0.1.0.0 */
#ifndef VERSION_mlhas
#define VERSION_mlhas "0.1.0.0"
#endif /* VERSION_mlhas */
#ifndef MIN_VERSION_mlhas
#define MIN_VERSION_mlhas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mlhas */
...
#define CURRENT_COMPONENT_ID "mlhas-0.1.0.0-inplace-mlhas"
